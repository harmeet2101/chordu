...
class PlayerControlState extends State<PlayerControls>{
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    ...
                    InkWell(
                      ...
                      state.controller.seekTo(Duration(seconds: (state.controller.value.position
                          .inSeconds - 10)));
                    },
                    ),
                    InkWell(
                      child: Container(child:Align(child:
                      IconButton(icon: Icon(state.controller.value.isPlaying?
                    ...
                    InkWell(
                      ...
                      state.controller.seekTo(Duration(seconds: (state.controller.value.position.inSeconds + 10)));
                    }:null,
                    ),
                    InkWell(
                      child: Container(child: Padding(
                        padding: const EdgeInsets.symmetric(vertical: 20),
                        child: Center(child: IconButton(icon: Icon(state.muted?Icons.volume_off:
                        Icons.volume_up,
                          color: Color(0xffA5A5A5),size: 36,),
                        )),
                      ),),onTap: state.isPlayerReady?(){
